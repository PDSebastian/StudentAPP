...
public class UsersConstants {
    public  final static   String  USER_ALREADY_EXIST_EXCEPTION_MESSAGE = "User ALREADY EXISTS";
    public static final String USER_ALREADY_DELETED_EXCEPTION_MESSAGE ="User ALREADY DELETED" ;
